...
#include "../../../../../../decentralized-interactive-lan-chat/src/connection.h"
...
QT_MOC_LITERAL(5, 36, 15), // "connectionReady"
QT_MOC_LITERAL(6, 52, 16), // "ProcessReadyRead"
QT_MOC_LITERAL(7, 69, 12) // "SendGreeting"

    },
    "Connection\0NewMessage\0\0from\0message\0"
    "connectionReady\0ProcessReadyRead\0"
    "SendGreeting"
};
...
void Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Connection::connectionReady)) {
                *result = 1;
                return;
            }
        }
